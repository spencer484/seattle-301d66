...
function displayPics() {
  ...
  // The variable rando is a locally scoped variable inside of the displayPics functoin to it is not able to be used from outside the makeRandom function. Therefore var has to be used
  console.log(viewed);
